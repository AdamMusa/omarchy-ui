...
raise "expanded DSL runtime is stale" unless OmarchyUI::Builder.instance_methods.include?(:badge)
raise "GPU DSL runtime is stale" unless OmarchyUI::Builder.instance_methods.include?(:shader_effect)
