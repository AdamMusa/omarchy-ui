...
module OmarchyUI
  ...
  COMPONENTS = {
    ...
    dialog: [%i[title opened x y width height modal dim focus close_policy standard_buttons layout spacing padding enabled background foreground border_color radius font_family font_size visible], %i[accept reject apply reset discard help open close about_to_show about_to_hide show hide focus blur], true],
    alert_dialog: [%i[title message informative_text detailed_text severity opened x y width height details_height modal dim focus close_policy standard_buttons spacing padding enabled background foreground muted accent warning_color error_color success_color border_color radius font_family font_size message_size details_size visible], %i[accept reject apply reset discard help open close about_to_show about_to_hide show hide focus blur], false],
