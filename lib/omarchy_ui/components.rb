...
module OmarchyUI
  ...
  COMPONENTS = {
    ...
    carousel: [%i[items key_field label_field description_field image_field current_index path_radius item_width item_height width height interactive highlight_range snap_mode background foreground muted accent font_family font_size visible], %i[input change activate movement_start movement_end], false],
    ...
    audio_input: [%i[device muted volume visible], %i[device_change muted_change volume_change], false],
    audio_output: [%i[device muted volume visible], %i[device_change muted_change volume_change], false],
